...
type
  TServiceTask = interface
    ['{828D139A-AE15-4C00-A26F-06A995FD0756}']
  ...
  TTaskServiceBase = class(TInterfacedObject, TServiceTask)
  public
  ...
  public
    class function CreateService: TServiceTask;
  end;
...
begin
  ...
  try
    ...
    begin
      JSONObj := TJSONObject.ParseJSONValue(RESTResponse.Content) as TJSONObject;
      if Assigned(JSONObj) then
        Result := JSONObj.GetValue<Double>('average_priority')
      else
        Result := 0;
    end
    else
...
class function TTaskServiceFactory.CreateService: TServiceTask;
begin
